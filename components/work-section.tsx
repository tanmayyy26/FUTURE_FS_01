...
const projects: Project[] = [
  {
    title: "Car Website",
    desc: "A comprehensive car showroom website showcasing vehicles with detailed information, interactive features, and seamless browsing experience for customers.",
    tech: ["HTML", "CSS", "JAVASCRIPT"],
    live: "https://tanmayyy26.github.io/CAR-WEBSITE/",
    repo: "https://github.com/tanmayyy26/CAR-WEBSITE",
  },
  {
    title: "WorldSim",
    desc: "Advanced multi-agent adaptive regional simulation platform combining climate modeling, economic systems, and AI governance using MAPPO algorithm to simulate 10+ regional agents competing for resources.",
    tech: ["REACT", "TYPESCRIPT", "TAILWIND CSS", "PYTHON", "PYTORCH", "MAPPO"],
    live: "https://world-sim-seven.vercel.app/",
    repo: "https://github.com/tanmayyy26/WorldSim",
  },
  {
    title: "K8sDoctor",
    desc: "Kubernetes diagnostic and monitoring tool providing real-time cluster health analysis, resource optimization, and troubleshooting capabilities for Kubernetes deployments.",
    tech: ["REACT", "TYPESCRIPT", "TAILWIND CSS", "RECHARTS"],
    live: "https://k8s-doctor.vercel.app/",
    repo: "https://github.com/tanmayyy26/K8sDoctor",
  },
  {
    title: "SakhiSecure",
    desc: "AI-powered women safety platform with real-time location tracking, incident reporting, predictive risk analysis using machine learning, and emergency alerts for immediate support.",
    tech: ["FLASK", "PYTHON", "MYSQL", "MACHINE LEARNING", "GROQ AI", "SCIKIT-LEARN"],
    live: "https://sakhi-secure.vercel.app/",
    repo: "https://github.com/tanmayyy26/SakhiSecure",
  },
  {
    title: "Docslot",
    desc: "A comprehensive doctor appointment booking system with features for both patients and doctors.",
    tech: ["NEXT.JS", "TAILWIND CSS", "TYPESCRIPT", "MONGODB"],
    live: "https://doc-slot-gcoen.vercel.app/",
    repo: "https://github.com/tanmayyy26/DocSlot",
  },
  {
